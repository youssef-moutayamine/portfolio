        ...
        <AnimatePresence mode="wait">
            {isOpen && (
                <>
                    ...
                    >
                        <div className="bg-gray-900/95 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-red-500/20">
                            <div className="flex flex-col items-center gap-6">
                                <h3 className="text-2xl font-bold text-white">
                                    Connect with <span className="text-red-400">me</span>
                                </h3>
                                <div className="flex gap-6">
                                    ...
                                    {/* Instagram */}
                                    <a 
                                        href="https://www.instagram.com/youssef._.mt/" 
                                        target="_blank" 
                                        rel="noopener noreferrer"
                                        className="w-12 h-12 bg-gray-800 hover:bg-red-500 rounded-full flex items-center justify-center transition-all duration-200 group"
                                    >

                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center gap-4 group cursor-pointer">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-medium text-gray-800">moutayamineyoussef6@email.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 group cursor-pointer">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-medium text-gray-800">+212 621 749-514</p>
                                        </div>
                                    </div>
                                    ...
                                    {/* <div className="flex items-center gap-4 group cursor-pointer">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-medium text-gray-800">Kuala Lumpur, Malaysia</p>
                                        </div>
                                    </div> */}
                                </div>
                        ...
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:bg-white/90 transition-all duration-300">
                            ...
                            <form className="space-y-6">
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-red-500 hover:bg-red-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
                                >
                                    Send Message
                                </button>
                            </form>

                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button className="bg-white/70 backdrop-blur-sm m-auto hover:bg-white text-red-600 font-semibold py-3 px-8 rounded-full transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl border border-red-200 flex items-center justify-center gap-2">
